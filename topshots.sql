...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2018 at 11:24 PM
...
INSERT INTO `comments` (`commentID`, `gameID`, `username`, `playername`, `description`, `timestamp`, `playerID`, `playerTeam`) VALUES
(30, 0, 'user', '', 'russell westbrook is a beast', '1523312956', 1, 'Oklahoma City Thunder'),
(31, 0, 'user', '', 'Comment about butler', '1523314192', 14, 'Chicago Bulls'),
(32, 0, 'user', '', 'hello there', '1523371107', 3, 'Boston Celtics');
...
INSERT INTO `following` (`username`, `playername`, `playerid`, `playerTeam`, `twitter`) VALUES
('user', 'John Wall', 18, 'Washington Wizards', ''),
('user', 'Isaiah Thomas', 3, 'Boston Celtics', 'https://twitter.com/isaiahthomas?ref_src=twsrc%5Etfw');
...
INSERT INTO `members` (`username`, `email`, `password`, `favouritePlayer`, `favouriteTeam`, `first_name`, `last_name`) VALUES
('jayantt', 'jayantt@sfu.ca', '$2y$10$vTDE0FQBNy8pRM52WkAnI.x8vBFgy0B2hkC6Ep6xBxaVvtcjbbLIS', '', 'LAC', 'Jay', 'Tailor'),
('user', 'email', '$2y$10$gqTNhA/ScJqm/lKDVOORYuVKySFgeM/g1LjIiXvl8uO59FyX42vDm', '', 'BKN', 'name', 'name');
...
--
ALTER TABLE `comments`
  MODIFY `commentID` smallint(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
